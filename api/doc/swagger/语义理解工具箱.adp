        ...
        "tools": [
          {
            ...
            "metadata": {
              ...
              "path": "/api/v1/data-semantic/{id}/fields",
              "method": "GET",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "重新执行业务对象识别,生成新的识别结果",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/business-objects/regenerate",
              "method": "POST",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "用户确认理解数据无误后提交,将临时表数据迁移到正式表",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/submit",
              "method": "POST",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "调用AI模型一键生成字段语义补全数据",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/generate",
              "method": "POST",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "删除指定表单视图的业务对象识别结果",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/business-objects",
              "method": "DELETE",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "将指定属性移动到另一个业务对象下",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/business-objects/attributes/move",
              "method": "PUT",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "保存用户编辑的表信息和字段信息",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/semantic-info",
              "method": "PUT",
          ...
          },
          {
            ...
            "metadata": {
              ...
              "description": "返回指定表单视图的数据理解状态",
              "server_url": "http://data-semantic-data-semantic-api:8888",
              "path": "/api/v1/data-semantic/{id}/status",
              "method": "GET",
