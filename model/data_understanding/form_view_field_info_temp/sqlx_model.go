...
func (m *FormViewFieldInfoTempModelImpl) DeleteByFormViewId(ctx context.Context, formViewId string) error {
...
func (m *FormViewFieldInfoTempModelImpl) DeleteByFormFieldId(ctx context.Context, formViewFieldId string) error {
	query := `UPDATE t_form_view_field_info_temp SET deleted_at = NOW(3) WHERE form_view_field_id = ?`
	_, err := m.db.ExecContext(ctx, query, formViewFieldId)
	if err != nil {
